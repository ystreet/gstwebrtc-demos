 ...
 *
 * gcc webrtc-datachannel.c $(pkg-config --cflags --libs gstreamer-webrtc-1.0 gstreamer-sdp-1.0 libsoup-2.4 json-glib-1.0) -o webrtc-sendrecv
 *
...
start_pipeline (void)
{
  ...
  /* create the data channel object and listen for some state changes */
...
main (int argc, char *argv[])
{
  ...
  g_clear_object (&send_channel);
  g_clear_object (&receive_channel);
